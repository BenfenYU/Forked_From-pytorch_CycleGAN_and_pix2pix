...
class CycleGANModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        if is_train:
            ...
            parser.add_argument('--lambda_G_A', type=float, default=2.0, help='weight for cycle loss (A -> B -> A)')
            parser.add_argument('--lambda_G_B', type=float, default=2.0, help='weight for cycle loss (B -> A -> B)')
